...
reference: http://mathewsanders.com/interactive-transitions-in-swift/
https://github.com/mathewsanders/Interactive-Transition-Swift-Tutorial

- simplified by removing references to statusbar, updated enterPanGesture, etc.
- for some reason, it works best in xcode 7.0 simulator when menu view background is transparent. 
...
class MenuTransitionManager: UIPercentDrivenInteractiveTransition, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate {
    ...
    // performing our exitSegue to start the transition
